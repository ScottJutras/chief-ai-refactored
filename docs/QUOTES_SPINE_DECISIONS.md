# Quote Spine Decisions Log

Active architectural patterns and invariants for the Quote spine.
Each §17.N subsection is a CIL architecture principle; §3A is a
co-transition asymmetry rule. Production ceremony artifacts
(§27, §28, §30, future §31/§32) live in
`docs/QUOTES_SPINE_CEREMONIES.md`.

Section-number convention: numbers persist across the split.
§17.23 has always been and will always be §17.23, regardless of
which file holds it.
