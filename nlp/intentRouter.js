...
const tools = [
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: { name: { type: 'string', description: 'Job name or address' } },
        required: ['name'],
      },
    },
  },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: { title: { type: 'string', description: 'The task text to send to everyone' } },
        required: ['title'],
      },
    },
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: { client: { type: 'string' }, quote_id: { type: 'string' } },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: { job: { type: 'string' }, amount: { type: 'number' } },
        required: ['job', 'amount'],
      },
    },
  },
...
async function routeWithAI(text, context = {}) {
  ...
  if (!INTENT_ROUTER_FALLBACK_ENABLED) return null;
...
async function route(text, context = {}) {
  ...
  if (looksLikeTask(t)) {
    ...
    return {
      ...
      args: { title: parsed.title, dueAt: parsed.dueAt, assigneeName: parsed.assignee },
    };
  }
